<template>
  <div class="contacts">
    ...
    <nav class="contacts__links navbar">
      <a class="navbar__link" href="https://github.com/wvovaw">
      ...
      <a class="navbar__link" href="https://t.me/gerserk">
        <svg
          version="1.1"
          id="Capa_1"
      ...
      <a
        class="navbar__link"
        href="https://discordapp.com/users/287283242854383618"
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          x="0px"
      ...
      <div class="navbar__music">
        <iframe
          ...
          frameborder="no"
          allow="autoplay"
          src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/831786061&color=%23285054&auto_play=false&hide_related=true&show_comments=false&show_user=true&show_reposts=false&show_teaser=false"
        ></iframe>
      </div>
    </nav>
  </div>
